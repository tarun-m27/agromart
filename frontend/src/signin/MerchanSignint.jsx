...
const MerchantSignin = () => {
  ...
  const handleExistingUserLogin = () => {
    navigate("/merchant-login"); // Ensure this points to the correct route
  };

  return (
    <div className="flex justify-center items-center h-screen bg-black bg-opacity-75">
      <div className="bg-white p-11 py-16 rounded-lg shadow-md w-full max-w-md">
        <h2 className="text-black text-2xl font-bold mb-4">Merchant Sign In</h2>
